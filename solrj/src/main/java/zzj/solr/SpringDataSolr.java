...
import zzj.DemoApplication;
import zzj.pojo.DemoPojo;
...
public class SpringDataSolr {
    ...
    public void testInsert(){
        ...
        doc.setField("id","002");
        doc.setField("naem","这是一个手机3");
        doc.setField("price","90000");
//        solrTemplate.saveDocument("testcore",doc);
